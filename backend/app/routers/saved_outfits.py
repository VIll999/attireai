    ...
    for saved in saved_outfits:
        ...
        if recommendation:
            ...
            rec_dict = {
                ...
                "total_price": float(recommendation.total_price) if recommendation.total_price is not None else None,
                ...
                "items": [
                    {
                        ...
                        "price_changed_at": item.price_changed_at.isoformat() if item.price_changed_at else None,
