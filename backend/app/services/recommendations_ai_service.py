...
class RecommendationsAIService:
    ...
    def _get_style_preference(self, db: Session, user_id: str) -> Optional[StylePreference]:
        return db.query(StylePreference).filter(StylePreference.user_id == user_id).first()
    ...
    def _build_context_payload(
        ...
        style: Optional[StylePreference],
