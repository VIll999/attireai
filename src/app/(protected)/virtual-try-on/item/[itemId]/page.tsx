...
export default function VirtualTryOnItemPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const r = await generateTryOnItem(user.uid, itemId, photoUrl);
      setResult(r);
    } catch (err) {
    ...
    <div className="min-h-screen bg-[#f8fafb] dark:bg-stone-950">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-stone-900 dark:text-stone-100">Try On Single Item</h1>
            <p className="text-stone-600 dark:text-stone-400 mt-1">
              Upload a full-body photo and we&apos;ll generate a preview of just this item on you.
            </p>
          </div>
